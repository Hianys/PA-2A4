<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold">@lang("My Accepted Missions")</h2>
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto py-6 space-y-8">
        ...
        <div class="flex justify-between">
            ...
            <a href="{{ route('provider.annonces.index') }}" class="text-indigo-600 hover:underline text-sm">
                @lang("← Back to available offers")
            </a>
        </div>

        @if ($annonces->count())
            <div class="bg-white shadow rounded-lg p-6">
                <h3 class="text-lg font-semibold mb-4">@lang("Accepted Service Missions")</h3>
                <ul class="space-y-4">
        ...
        @else
            <p class="text-center text-gray-500">@lang("You haven't accepted any missions yet.")</p>
        @endif
    </div>
</x-app-layout>